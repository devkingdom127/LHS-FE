...
class ManageStaff extends React.Component {
    ...
    getStaffByQuery = async () => {        
        ...
        token = "Bearer " + token;
        var res = await callApi('POST', '/v1/LHS/staff/getByQuery', token, data);
        ...
        this.setState({staffs: [...res.data.staffs], total: res.data.total, totalPage: totalPage});
    }
        ...
        return (
            <div className="theme2_body" style={{backgroundColor: 'rgba(0,0,0,0)'}}>  
                <div className="t2_sp_work" style={{marginTop: 0}}>
                    ...
                    <div className="row" style={{overflowX: 'auto', marginTop: '32px', display: this.state.staffs.length?"block":"none"}}>
